...
__attribute__((section(".crt0"))) const int sinWindowEWram[128 + 1024] = {
/* 128 - format = Q31 * 2^0 */
...
__attribute__((section(".crt0"))) const int kbdWindowEWram[128 + 1024] = {
/* 128 - format = Q31 * 2^0 */
...
__attribute__((section(".crt0"))) const int twidTabOddEWram[8*6 + 32*6 + 128*6] = {
...
__attribute__((section(".crt0"))) const int twidTabEvenEWram[4*6 + 16*6 + 64*6] = {
